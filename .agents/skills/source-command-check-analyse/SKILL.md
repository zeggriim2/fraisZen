---
name: "source-command-check-analyse"
description: "Migrated source command `check-analyse`"
---

# source-command-check-analyse

Use this skill when the user asks to run the migrated source command `check-analyse`.
