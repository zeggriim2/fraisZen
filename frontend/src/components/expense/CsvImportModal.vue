<template>
  <BaseModal max-width="xl" @close="$emit('close')">
    <template #title>Import relevé bancaire</template>
    <template #subtitle>Détection automatique des péages et repas</template>
    ...
    <template v-if="detectedRows.length" #footer>
