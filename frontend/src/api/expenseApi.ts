...
import type { CreateExpenseDto, UpdateExpenseDto, Expense, ExpenseSummary, TaxDeductionComparison } from '@/types'
...
export const expenseApi = {
  ...
  getComparison: (personId: string, year: number, taxableSalary: number) =>
    http.get<TaxDeductionComparison>('/expenses/comparison', { params: { personId, year, taxableSalary } }).then(r => r.data),
